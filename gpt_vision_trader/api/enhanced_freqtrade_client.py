#!/usr/bin/env python3
"""
Enhanced Freqtrade Client with GPT Reasoning
============================================

Enhanced Freqtrade REST API client that uses the official ft_rest_client
...
class EnhancedFreqtradeClient:
    """
    Enhanced Freqtrade API client that uses the official ft_rest_client
    ...
    def __init__(self, config: FreqtradeConfig):
        ...
        self.logger.info(f"Enhanced FreqtradeClient initialized for {config.base_url}")
...
class EnhancedTradingOperations:
    """
    Enhanced trading operations that include GPT reasoning in trades.
    """
    
    def __init__(self, api_client: EnhancedFreqtradeClient):
        """
        Initialize enhanced trading operations.
        
        Args:
            api_client: Enhanced Freqtrade API client instance
        """
        self.api = api_client
        self.logger = logging.getLogger(__name__)
